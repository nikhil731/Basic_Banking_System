...
<body>
  ...
  ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row activity text-center">
            ...
            <div class="col-md act">
                <br><br>
                <img src="img/users.jpg" class="img-fluid"  width="250">
                <br><br>
                <a href="transfermoney.php"><button>View all Users</button></a>
            </div>
            <div class="col-md act">
                <br><br>
                <img src="img/transfer_money.png" class="img-fluid"  width="250" >
                <br><br>
                <a href="transfermoney.php"><button>Transfer Money</button></a>
            </div>
            <div class="col-md act">
                <img src="img/history.png" class="img-fluid" width="450" >
                <br>
    ...
    <footer class="text-center mt-5 py-2">
        <p>&copy 2022. Made by <b>Nikhil Kadam</b> <br> For the Project of  <b>The Sparks Foundation</b></p>
    </footer>
